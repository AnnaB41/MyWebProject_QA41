...
public class AddPage extends BasePage {
    ...
    WebElement nameField; // находим через экспект это поле и здесь говорим, что в это место установить элемент nameField
    ...
    public void fillFormAndSave(Contact contact){
        ...
        WebDriverWait wait = new WebDriverWait(driver, Duration.ofSeconds(5)); //ожидаем, когда появится кнопка Save
