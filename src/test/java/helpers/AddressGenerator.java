...
//    }
   ...
   private static final Random random = new Random();
    ...
    public static String generateAddress(){
        ...
        String city = cities[random.nextInt(cities.length)]; //выбери из конкретного массива случайное значение, с учетом длины массива
        String street = streets[random.nextInt(streets.length)];
        int number = random.nextInt(300); //выбери в пределах 300 любое число
